...
Version 2026.16 (v16). A web-based benefit-cost analysis decision aid for
...
3. Wait for the green check, then open
   https://YOURNAME.github.io/REPO/ (for this tool, the v16 URL).
4. After any change, the asset query strings (?v=16-1) force browsers to fetch
   the new files; bump them (e.g. ?v=16-2) when you publish further changes.
